...
<tr><td>process_timeseries.py</td><td>Plots and summarizes GSLMO timeseries data.</td>Combined, quality-checked files for all HOBO data loggers plus lake elevation data<td></td><td>ResearchModules.py</td></tr>
