...
<tr><td>DataProcessing.py</td><td>Work in progress! Master data processing script. Builds HTML pages of static and bokeh interactive plots for GSLMO website updating. Right now it only plots HOBO data. Code to import raw HOBO data, match it to weather station data, and update the compiled HOBO data files is in progress.</td><td>HOBO_SiteA.csv, HOBO_SiteB.csv, raw offloaded HOBO csv files</td><td></td></tr>
